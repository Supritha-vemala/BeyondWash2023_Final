...
const BookingDetailsForDates = () => {
  ...
  useEffect(() => {
    ...
    route?.params?.item?.ServiceDates?.forEach(data => {
  ...
  function renderImageItem({item}) {
    return (
      <Image
        ...
        source={{
          uri: `https://firebasestorage.googleapis.com/v0/b/beyondwash-c2b4f.appspot.com/o/Bookings%2F${item}?alt=media&token=${imageData[item]}`,
        }}
      />
    );
  }
